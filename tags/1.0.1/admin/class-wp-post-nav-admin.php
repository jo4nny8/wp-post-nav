  ...
  */
  ...
  private function settings_fields() {
    ...
    $settings['post_types'] = array(
      ...
      'description'     => __( 'Select The Post Types You Will Use The Navigation On', $this->textdomain ),
      'fields'        => array(
        array(
          'label' => 'Post Types',
    ...
    if ( class_exists('WPSEO_Primary_Term') ) {
      $settings['post_types']['fields'][] = array (
          ...
          'default'=> '',
          'after' => 'Show The Next / Previous Posts In The Same \'Primary Category\' From Yoast SEO?',
