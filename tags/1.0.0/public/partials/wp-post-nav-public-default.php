...
if ($yoast_primary == 'yes') {
  if ( class_exists('WPSEO_Primary_Term') ) {
    ...
    $wpseo_primary_term = new WPSEO_Primary_Term( $term, get_the_id() );
...
//We have posts - lets do this
  ...
  $heading = ucfirst(get_post_type());
  $heading = apply_filters( 'wp-post-nav-heading', $heading);
