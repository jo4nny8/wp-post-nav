...
//if (!get_option (option_name->version)) {
 // echo 'Version: ' . $version . 'is in use';
//}
...
<div id="wp-post-nav-instructions">
  ...
  <table>
    ...
    <tr>
      <td class="wp-post-nav-centered"><strong>wp-post-nav-heading</strong></td>
      <td>Alter the 'next' / 'previous' heading</td>
      <td>By default, we use the post type name as the heading.  Use this filter to change this to something else.  For example, if you dont want to say 'next post' you can alter the heading to 'next article' or 'next blog' and such.</td> 
    </tr>
  </table>
</div>
